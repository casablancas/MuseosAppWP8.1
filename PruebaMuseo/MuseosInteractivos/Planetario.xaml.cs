...
{
    public partial class Planetario : PhoneApplicationPage
    {
        public Planetario()
        {
            InitializeComponent();
        ...
        private async void btnMapas_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                BingMapsDirectionsTask bing = new BingMapsDirectionsTask()
                {
                    ...
                    End = new LabeledMapLocation("Planetario", new GeoCoordinate(19.057053, -98.181645))
                };
        ...
        {
            await Launcher.LaunchUriAsync(new Uri("http://www.planetariopuebla.com/"));
        }

        private async void btnFacebook_Click(object sender, RoutedEventArgs e)
        {
            await Launcher.LaunchUriAsync(new Uri("fb:pages?id=276366755786312"));
        }
    }
}