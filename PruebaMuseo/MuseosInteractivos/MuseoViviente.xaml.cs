...
{
    public partial class MuseoViviente : PhoneApplicationPage
    {
        public MuseoViviente()
        {
            InitializeComponent();
        }
        ...
        private async void btnMapas_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                BingMapsDirectionsTask bing = new BingMapsDirectionsTask()
                {
                    ...
                    End = new LabeledMapLocation("Museo Viviente", new GeoCoordinate(19.040733, -98.197467))
                };
        ...
        {
            await Launcher.LaunchUriAsync(new Uri("www.museoviviente.com/"));
        }
    }
}