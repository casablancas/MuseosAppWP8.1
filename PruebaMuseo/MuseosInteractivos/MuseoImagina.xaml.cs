...
{
    public partial class MuseoImagina : PhoneApplicationPage
    {
        public MuseoImagina()
        {
            InitializeComponent();
        ...
        private async void btnMapas_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                BingMapsDirectionsTask bing = new BingMapsDirectionsTask()
                {
                    ...
                    End = new LabeledMapLocation("Museo Imagina", new GeoCoordinate(19.057816, -98.181426))
                };
        ...
        {
            await Launcher.LaunchUriAsync(new Uri("http://www.puebla.travel/es/museos/item/museo-imagina-2"));
        }

        private async void btnFacebook_Click(object sender, RoutedEventArgs e)
        {
            await Launcher.LaunchUriAsync(new Uri("fb:pages?id=100006643480013"));
        }
    }
}